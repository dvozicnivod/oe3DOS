...
nfft = 512;                             %velicina ta?aka ffta je manja jer
window_width = nfft;                    %je smanjen broj odbiraka
overlap_num = 3/4*window_width;
ws = hamming(window_width);
...
%uzimam svaki n-ti odbirak, metodom pukušaja za razlicite vrednosti n sam
